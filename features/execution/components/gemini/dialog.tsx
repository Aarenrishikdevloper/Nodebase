...
const GeminiDialog = ({
  ...
  const watchVariableName = form.watch("variableName") || "mygeminiAPI"   
  const {data:credentials, isLoading:isloadingCredential} = useCredentialsByType(CredentialsType.GEMINI)  
